    ...
    >
      <style>{`
        .admin-login-card {
          ...
          box-shadow: 0 25px 60px -15px rgba(0, 0, 0, 0.12), 0 2px 10px rgba(0, 0, 0, 0.04);
          display: grid;
      ...
      <div className="admin-login-card">
        {/* Left Column: Identity & Live System Status */}
        <div
        ...
        >
          <div>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 18 }}>
              ...
              <div>
                <h3 style={{ margin: 0, fontSize: 15, fontWeight: 700, color: "var(--text-primary, #0f172a)" }}>
                  Sujith Thota
                </h3>
            ...
            {/* Live System Status Stack (4 Pill Cards) */}
        ...
        <div style={{ padding: "32px 32px", display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
          <div>
            ...
            <div style={{ marginBottom: 20 }}>
              <h1 style={{ margin: 0, fontSize: 24, fontWeight: 600, color: "var(--text-primary, #0f172a)", letterSpacing: "-0.02em" }}>
                Admin Portal
              </h1>
            ...
            {/* Stepper (3 steps) */}
            <div style={{ display: "flex", borderBottom: "1px solid var(--border-color, #e2e8f0)", marginBottom: 24 }}>
              <button
                type="button"
              ...
              <>
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
                    {!emailOtpSent ? (
                      <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
                        ...
                        >
                          {loading ? "Dispatching 6-Digit Code..." : <>Send Security OTP <ArrowRight size={14} /></>}
                        </button>
                      </div>
                    ) : (
                      <form onSubmit={handleVerifyEmailOtp} style={{ display: "flex", flexDirection: "column", gap: 14 }}>
                        <div style={{ textAlign: "center" }}>
                          <p style={{ margin: 0, fontSize: 12.5, color: "var(--text-secondary, #475569)" }}>
                ...
                {activeStep === 2 && (
                  <div style={{ display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center", gap: 14 }}>
                    ...
                    <div>
                      <h4 style={{ margin: 0, fontSize: 14.5, fontWeight: 700 }}>Hardware Passkey & WebAuthn</h4>
                      <p style={{ margin: "4px 0 0", fontSize: 12, color: "var(--text-muted, #64748b)", maxWidth: 300 }}>
                        Authenticate instantly with Touch ID, Face ID, Windows Hello, or your FIDO2 security key.
                      </p>
                    </div>
          ...
          <div style={{ marginTop: 24, paddingTop: 16, borderTop: "1px solid var(--border-color, #e2e8f0)" }}>
            ...
            <p style={{ margin: "10px 0 0", fontSize: 11, color: "var(--text-muted, #94a3b8)", textAlign: "center" }}>
        ...
        {showHelpModal && (
          ...
          >
            ...
            >
              ...
              <div style={{ marginTop: 16, paddingTop: 12, borderTop: "1px solid var(--border-color, #e2e8f0)", fontSize: 11.5, color: "var(--text-muted, #64748b)" }}>
          ...
          >
            ...
            >
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 16 }}>
                <div>
                  <h3 style={{ margin: 0, fontSize: 16, fontWeight: 700, display: "flex", alignItems: "center", gap: 8 }}>
                    <Activity size={18} color="#10b981" /> System Telemetry
                  </h3>
                  <p style={{ margin: "2px 0 0", fontSize: 11.5, color: "#10b981", fontWeight: 600 }}>
