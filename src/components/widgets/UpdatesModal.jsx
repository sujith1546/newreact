        ...
        >
          ...
          <div
            style={{
              ...
              borderRadius: '50%',
              background: isDarkMode
                ? 'radial-gradient(circle, rgba(59, 130, 246, 0.18) 0%, rgba(6, 182, 212, 0.08) 45%, transparent 70%)'
                : 'radial-gradient(circle, rgba(59, 130, 246, 0.12) 0%, rgba(6, 182, 212, 0.06) 45%, transparent 70%)',
              filter: 'blur(40px)',
              pointerEvents: 'none',
              zIndex: 0,
            }}
          ...
          >
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                ...
                >
                  <Sparkles size={14} fill="#ffffff" color="#ffffff" />
                </div>
                <div>
