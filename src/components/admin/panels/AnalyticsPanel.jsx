...
import { Loader2, Sparkles, TrendingUp, Users, Compass, Laptop, Smartphone } from 'lucide-react';
      ...
      >
        <div style={{ padding: '20px 22px', display: 'flex', flexDirection: 'column', gap: 24 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(150px, 1fr))', gap: 14 }}>
            {[
              { label: 'Active Live Sessions', value: visitorCount || 1, color: '#10b981' },
              { label: 'Total Page Views', value: analytics.length, color: '#3b82f6' },
              { label: 'Recruiter Events', value: events.length, color: '#8b5cf6' },
