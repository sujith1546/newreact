...
const DesktopAbout = lazy(() => import('./DesktopAbout'));
const DesktopSkills = lazy(() => import('./DesktopSkills'));
const DesktopProjects = lazy(() => import('./DesktopProjects'));
const DesktopEducation = lazy(() => import('./DesktopEducation'));
const DesktopExperience = lazy(() => import('./DesktopExperience'));
const DesktopCertifications = lazy(() => import('./DesktopCertifications'));
const DesktopContact = lazy(() => import('./DesktopContact'));
...
const SECTIONS_DEF = [
  { id: 'home',           Component: DesktopHome          },
  { id: 'about',          Component: DesktopAbout         },
  { id: 'skills',         Component: DesktopSkills        },
  { id: 'projects',       Component: DesktopProjects      },
  { id: 'education',      Component: DesktopEducation     },
  { id: 'experience',     Component: DesktopExperience    },
  { id: 'certifications', Component: DesktopCertifications},
  { id: 'contact',        Component: DesktopContact       },
];
...
export default function DesktopLayout() {
  ...
  const ActiveComponent = SECTIONS.find(s => s.id === activeSection)?.Component ?? DesktopHome;
