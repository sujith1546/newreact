    ...
    <ScrollReveal className="wide-content">
      <style>{`
        ...
        @media (max-width: 900px) {
          ...
          .mcert-title-row { display: flex; align-items: center; gap: 6px; margin-bottom: 2px; flex-wrap: wrap; }
          .mcert-title { font-size: 13px; font-weight: 700; color: var(--text-primary); margin: 0; line-height: 1.2; }
          .mcert-issuer { font-size: 10px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.05em; margin: 0; }
